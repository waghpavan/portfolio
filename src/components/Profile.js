...
const Profile = () => {
  ...
  return (
    <section className="dark:text-white dark:border-white border-black border-b flex flex-col mt-20 items-center text-center py-8 px-6 md:py-8 lg:py-12">
      {/* Title */}
      <h1 className="text-2xl md:text-3xl lg:text-2xl font-semibold leading-snug animate-fade-in-left">
